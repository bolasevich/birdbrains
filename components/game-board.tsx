...
export default function GameBoard({ cards, onCardClick, lockBoard, difficulty }: GameBoardProps) {
  ...
  return (
  <div 
  className="grid gap-3 sm:gap-4 md:gap-5 py-8 px-4 sm:py-12 sm:px-6 md:py-16 md:px-8 
             rounded-xl shadow-2xl max-w-2xl w-full aspect-square mb-8 overflow-hidden"
  style={{
