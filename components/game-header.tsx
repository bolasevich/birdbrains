...
export default function GameHeader({ 
  ...
  return (
    <CustomCard className="w-full max-w-2xl mb-4 sm:mb-6 bg-[#008bd5] shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-1 sm:gap-2 text-xs sm:text-sm text-white">
