    ...
    <CustomDialog open={isOpen} onOpenChange={onOpenChange}>
      <CustomDialogContent className="max-w-sm sm:max-w-md w-[95vw] max-h-[90vh] overflow-y-auto">
        <CustomDialogHeader className="pb-4">
          <CustomDialogTitle className="flex items-center gap-2 text-lg sm:text-xl text-white">
        ...
        <div className="space-y-6 px-1">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3">Difficulty</h3>
          ...
          {/* Game Mode Selection */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3">Game Mode</h3>
          ...
          {/* Theme Selection */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3">Theme</h3>
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
